...
const GetTopicHashLogs = (props) => {
  ...
  const URL_String = `https://api.covalenthq.com/v1/${network.value}/events/topics/${topicHash}/?starting-block=${startingBlock}&ending-block=${endingBlock}&sender-address=${address}&page-number=${pageNumber}&page-size=${pageSize}&format=csv`
